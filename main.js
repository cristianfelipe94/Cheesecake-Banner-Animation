...
const _imageArray = new Array(
    'cheesecake-background.jpg',
    'blue-background.jpg',
    'blue-action-cta.png',
    'yellow-action-cta.png',
    'first-arrow-anim.png',
    'first-hit-phrase.png',
    'first-written-text.png',
    'product-bottle.png',
    'second-arrow-anim.png',
    'second-hit-phrase.png',
    'text-firstline.png',
    'text-secondline.png',
);
